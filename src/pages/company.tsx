  ...
  <div className=' '>
    ...
    <div className=' my-10 flex justify-center'>
      <table className='mx-auto border'>
        <tbody>
          <tr>
            <th className='w-60 border-b border-black bg-[#4d4d4d] py-5 text-white'>会社名</th>
            <td className='w-[500px] border-b pl-5'>株式会社プロジェクトジャパン</td>
          </tr>
          <tr>
            <th className='w-60 border-b border-black bg-[#4d4d4d] py-5 text-white'>代表取締役</th>
            <td className='w-[500px] border-b pl-5'>鈴木琢真</td>
          </tr>
          <tr>
            <th className='w-60 border-b border-black bg-[#4d4d4d] py-5 text-white'>所在地</th>
          ...
          <tr>
            <th className='w-60 border-b border-black bg-[#4d4d4d] py-5 text-white'>電話番号</th>
            <td className='w-[500px] border-b pl-5'>052-972-7871 / 052-972-7872</td>
          </tr>
          <tr>
            <th className='w-60 border-b border-black bg-[#4d4d4d] py-5 text-white'>設立年月</th>
